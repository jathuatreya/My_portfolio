...
import { BlogPost } from "@/app/data/blog-content";
import { profile } from "@/app/data/portfolio-data";

// Share links component extracted for cleaner code
const ShareButtons = ({ shareUrl, shareText, blogTitle }: { shareUrl: string, shareText: string, blogTitle: string }) => {
    const shareLinks = [
         {
              name: "WhatsApp",
...
export default function BlogDetailClient({ blog }: { blog: BlogPost | null }) {
     ...
     // Social Share Links
     const shareUrl = `https://www.jathushan.dev/blogs/${blog.id}`;
                              ...
                              <aside className="lg:col-span-1 relative hidden lg:block">
                                   ...
                                   >
                                        ...
                                        <div className="flex flex-col gap-5">
                                            <ShareButtons shareUrl={shareUrl} shareText={shareText} blogTitle={blog.title} />
                                        </div>
                                   </motion.div>
                              </aside>
