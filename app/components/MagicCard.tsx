...
const DEFAULT_PARTICLE_COUNT = 8; // Reduced for cleaner look
...
const GlobalSpotlight: React.FC<{
    ...
    `;
               ...
               const handleMouseMove = (e: MouseEvent) => {
                    ...
                    // Select all elements with the 'card--border-glow' class within the container
                    const cards = containerRef.current.querySelectorAll('.card--border-glow');
                    ...
                    cards.forEach(card => {
                         ...
                         // Calculate distance from mouse to card edge (roughly)
                    ...
                    // Show spotlight if near any card
                    const targetOpacity =
               ...
               const handleMouseLeave = () => {
                    ...
                    containerRef.current?.querySelectorAll('.card--border-glow').forEach(card => {
                         (card as HTMLElement).style.setProperty('--glow-intensity', '0');
                    });
...
export const MagicContainer: React.FC<{
     children: React.ReactNode;
     className?: string;
     glowColor?: string; // e.g. "0, 119, 237"
     ...
     return (
          ...
          .card--border-glow::after {
            ...
            position: absolute;
            inset: 0;
            padding: 2px; /* Thinner border for elegance */
            ...
            pointer-events: none;
            opacity: 0.5; /* Always slightly visible for structure */
